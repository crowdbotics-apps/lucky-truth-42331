"""
Django settings for lucky_truth_42331 project.
...
ROOT_URLCONF = 'lucky_truth_42331.urls'
...
WSGI_APPLICATION = 'lucky_truth_42331.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "lucky_truth_42331 API",
    "DESCRIPTION": "API documentation for lucky_truth_42331 App",
    "VERSION": "v1",
}
